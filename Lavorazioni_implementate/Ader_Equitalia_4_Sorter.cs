...
{
    //non più utilizzata
    //[ProcessingLavorazioneAttribute("ADER_EQUITALIA_4_SORTER")]
    //    public class Ader_Equitalia_4_Sorter : Lavorazione
    //    {
    ...
    //        public Ader_Equitalia_4_Sorter(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore
    //)
    //        {
    ...
    //        {
    //            this.TableData = new DataTable("ADER_EQUITALIA_4_SORTER");
    ...
    //                                     WHERE convert(date, DataScansione) >= @startDataScan and convert(date, DataScansione) <= @endDataScan and TipoScansione ='Sorter' ";

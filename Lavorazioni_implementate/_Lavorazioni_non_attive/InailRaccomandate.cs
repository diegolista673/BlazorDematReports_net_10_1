...
{
    [ProcessingLavorazioneAttribute("InailRaccomandate")]
    public class InailRaccomandate : Lavorazione
    {
        private readonly ILavorazioniConfigManager _lavorazioniConfigManager;
        private readonly NormalizzaOperatore _normalizzaOperatore;
        private readonly Logger logger;

        public InailRaccomandate(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore)
        {
        ...
        private DataTable FillTable()
        {
            ...
            this.TableData = new DataTable("InailRaccomandate");

            try
            {
                WebTopSearch wts = new WebTopSearch();
                wts.UrlLavorazione = _lavorazioniConfigManager.UrlWebtopInail;
                wts.User = _lavorazioniConfigManager.UserWebtopInail;
                wts.Password = _lavorazioniConfigManager.PasswordWebtopInail;

...
namespace LibraryLavorazioni.Lavorazioni
{
    ...
    public class ACI_RACCOMANDATE
    {
        //private readonly Logger logger;

        //public ACI_RACCOMANDATE(IDbContextFactory<DematReportsContext> repoContext, ILavorazioniConfigManager lavorazioniConfigManager) : base(repoContext, lavorazioniConfigManager)
        //{

...
{
    [ProcessingLavorazioneAttribute("ANT_ADER4_SORTER")]
    public class Ant_Ader4_SorterRelate : Lavorazione
    {
        ...
        public Ant_Ader4_SorterRelate(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore
)
        {
        ...
        {
            this.TableData = new DataTable("ANT_ADER4_SORTER");
            ...
            try
            {
                ...
                if (IDFaseLavorazione == 4)
                {
                    ...
                    //sorter1
                    using (SqlConnection connection = new SqlConnection(_lavorazioniConfigManager.CnxnAder4Sorter1))
                    {
                    ...
                    //sorter2
                    using (SqlConnection connection = new SqlConnection(_lavorazioniConfigManager.CnxnAder4Sorter2))
                    {
                        if (connection.State != ConnectionState.Open)
                        {
                            connection.Open();
                    ...
                    {
                        this.TableData.Rows.Add(dr.ItemArray);
                    }

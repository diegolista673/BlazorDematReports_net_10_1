...
namespace LibraryLavorazioni
{
    ...
    public class Ader_Equitalia_4 : Lavorazione
    {
        ...
        public Ader_Equitalia_4(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore
)
        {

...
{
    [ProcessingLavorazioneAttribute("Z0087287_GAIA_CONTRATTI")]
    public class Z0087287_GAIA_CONTRATTI : Lavorazione
    {
        ...
        public Z0087287_GAIA_CONTRATTI(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore)
        {
        ...
        {
            this.TableData = new DataTable("Z0087287_GAIA_CONTRATTI");
            ...
            try
            {
                ...
                if (IDFaseLavorazione == 4)
                {
                    ...
                    string query = @"select OP_SCAN  as Operatore, convert(date, DATA_SCAN) as DataLavorazione, COUNT(*) as Documenti
                                     from Z0087287_RDMKT_GAIA_CONTRATTI_UDA

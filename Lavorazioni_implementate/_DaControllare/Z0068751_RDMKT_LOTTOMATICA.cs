...
{
    [ProcessingLavorazioneAttribute("Z0068751_RDMKT_LOTTOMATICA")]
    public class Z0068751_RDMKT_LOTTOMATICA : Lavorazione
    {
        private readonly Logger logger;
        private readonly ILavorazioniConfigManager _lavorazioniConfigManager;
        private readonly NormalizzaOperatore _normalizzaOperatore;

        public Z0068751_RDMKT_LOTTOMATICA(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore)
        {
        ...
        {
            this.TableData = new DataTable("Z0068751_RDMKT_LOTTOMATICA");
            ...
            try
            {
                ...
                if (IDFaseLavorazione == 4)
                {
                    string query = @"select OP_SCAN  as Operatore, convert(date, DATA_SCAN) as DataLavorazione, COUNT(*) as Documenti
                                     from [Z0068751_RDMKT_LOTTOMATICA_TDG_UDA_DETTAGLIO]

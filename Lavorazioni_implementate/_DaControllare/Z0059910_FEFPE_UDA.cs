...
namespace LibraryLavorazioni
{
    ...
    [ProcessingLavorazioneAttribute("Z0059910_FEFPE_UDA")]
    public class Z0059910_FEFPE_UDA : Lavorazione
    {
        private readonly Logger logger;
        private readonly ILavorazioniConfigManager _lavorazioniConfigManager;
        private readonly NormalizzaOperatore _normalizzaOperatore;

        public Z0059910_FEFPE_UDA(ILavorazioniConfigManager lavorazioniConfigManager, NormalizzaOperatore normalizzaOperatore)
        {
        ...
        {
            this.TableData = new DataTable("Z0059910_FEFPE_UDA");

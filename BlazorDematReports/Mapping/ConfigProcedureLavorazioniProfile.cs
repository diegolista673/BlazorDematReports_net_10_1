    ...
    public class ConfigProcedureLavorazioniProfile : Profile
    {
        ...
        public ConfigProcedureLavorazioniProfile()
        {
            ...
            CreateMap<TaskDaEseguire, TaskDaEseguireDto>()
                ...
                .ForMember(dest => dest.Descrizione, opt => opt.MapFrom(src => src.IdTaskNavigation.Descrizione))
                .ForMember(dest => dest.TaskName, opt => opt.MapFrom(src => src.IdTaskNavigation.TaskName))
                ...
                .ForMember(dest => dest.TimeTask, opt => opt.MapFrom(src => src.TimeTask != null ? src.TimeTask.Value.ToTimeSpan() : (TimeSpan?)null))
            ...
            CreateMap<TaskDaEseguireDto, TaskDaEseguire>()
                ...
                .ForMember(dest => dest.IdTaskNavigation, opt => opt.Ignore())
                .ForMember(dest => dest.ConfigurazioneDatabase, opt => opt.Ignore())
                .ForMember(dest => dest.TimeTask, opt => opt.MapFrom(src => src.TimeTask.HasValue ? TimeOnly.FromTimeSpan(src.TimeTask.Value) : (TimeOnly?)null))
                .ForMember(dest => dest.Enabled, opt => opt.MapFrom(src => src.Enabled))
                .ForMember(dest => dest.CronExpression, opt => opt.MapFrom(src => src.CronExpression))
                .ForMember(dest => dest.LastRunUtc, opt => opt.MapFrom(src => src.LastRunUtc))
                .ForMember(dest => dest.LastError, opt => opt.MapFrom(src => src.LastError))

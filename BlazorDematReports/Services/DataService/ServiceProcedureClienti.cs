...
namespace BlazorDematReports.Services.DataService
{
    ...
    public class ServiceProcedureClienti : ServiceBase<ProcedureCliente>, IServiceProcedureClienti
    {
        ...
        private readonly ILogger<ServiceProcedureClienti> logger;
        ...
        public ServiceProcedureClienti(IMapper mapper, ConfigUser configUser, IDbContextFactory<DematReportsContext> contextFactory, ILogger<ServiceProcedureClienti> logger) : base(contextFactory)
        {
            this.mapper = mapper;

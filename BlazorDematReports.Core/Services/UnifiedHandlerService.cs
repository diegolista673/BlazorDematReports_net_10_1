...
namespace BlazorDematReports.Core.Services
{
    /// <summary>
    ...
    public class UnifiedHandlerService : IUnifiedHandlerService
    {
        ...
        {
            return Task.FromResult<IReadOnlyCollection<string>>(_registry.GetAllCodes().ToList());
        }
        ...
        /// <summary>
        /// Verifica se un handler è registrato.
        /// </summary>
        public bool IsHandlerRegistered(string handlerCode)
        {
            return _registry.IsRegistered(handlerCode);
        }

        /// <summary>
        /// Ottiene tutti i codici degli handler registrati.
        /// </summary>
        public IEnumerable<string> GetRegisteredHandlerCodes()
        {
            return _registry.GetAllCodes();
        }

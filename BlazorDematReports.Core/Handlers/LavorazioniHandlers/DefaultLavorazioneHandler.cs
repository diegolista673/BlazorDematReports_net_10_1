...
namespace BlazorDematReports.Core.Handlers.LavorazioniHandlers
{
    ...
    {
        /// <summary>
        /// Codice identificativo univoco della lavorazione di default.
        /// </summary>
        public string LavorazioneCode => LavorazioniCodes.DEFAULT;

        /// <summary>
        /// Esegue la lavorazione di default utilizzando il pattern registry e dependency injection.
        /// </summary>
        ...
        public async Task<List<DatiLavorazione>> ExecuteAsync(LavorazioneExecutionContext context, CancellationToken ct = default)
        {
            ...
            var lavorazione = new DefaultLavorazioneProcessor(normalizzatore, gestoreOperatori, elaboratore, configManager);
